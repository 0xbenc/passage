...
complete -c passage -n "__fish_use_subcommand" -a "insert" -d "Create or overwrite an entry"
...
complete -c passage -l multiline -d "Read whole stdin as the secret"
complete -c passage -l force -d "Overwrite an existing entry"
complete -c passage -l no-symbols -d "Generate alphanumeric only"
complete -c passage -l recursive -d "Remove a subtree"
